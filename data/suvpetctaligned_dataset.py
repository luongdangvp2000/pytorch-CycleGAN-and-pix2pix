import os
from data.base_dataset import BaseDataset, get_params, get_transform, get_transform_for_petct, norm_SUV
from data.image_folder import make_dataset, is_image_file
import numpy as np
import torch 


class SUVPetctAlignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        B_path = os.path.join(self.dir_AB,f"SUV__{self.AB_paths[index]}.npz")
