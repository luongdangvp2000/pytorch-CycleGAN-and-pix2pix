    ...
    for num_epochs, lam1, lam2 in zip(list_epochs, list_lambda1, list_lambda2):
        ...
        for eph in range(num_epochs):
            ...
            for i, batch in enumerate(train_loader):
                ...
                t0 = netD_A(rec_B) #"t0: Discriminator result of fake B"
                ...
                optimizerG.zero_grad()  #"self.optimizer_G.zero_grad()"
                total_loss.backward()   #"self.backward_G()"
                optimizerG.step()       #"self.optimizer_G.step()"

                #then discriminator
                netD_A.train()
                t0 = netD_A(xB) #"Discriminator result of real B"
        ...
        for eph in range(num_epochs):
            ...
            for i, batch in enumerate(train_loader):
                ...
                for nid, netG in enumerate(list_netG_A):
                    if nid == 0: #
                        rec_B, rec_alpha_B, rec_beta_B = netG(xA) #calculate fake image of B from real A
                    else:
